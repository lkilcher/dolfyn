# group attributes by 4-beam, 5th beam, echosounder or bottomtracker
# all other relevant attributes fall to Dataset
# add "shortened version" option to read function
...
# # @xr.register_dataset_accessor('orientation')
# # class orientation(axes):
# #     def __init__(self, xr_DS):
# #         self._obj = xr_DS
# #         self.vars = xr_DS.rotate_vars
    
# #         # set orient data to relevant instrument

# #     def change_orient(axes):
# #         if axes=='beam':
# #             # change coord 'orient' to beam
# #         if axes=='inst':
# #             # change coord 'orient' to instrument
# #         if axes=='earth':
# #             # check for magnetic declination
# #             # change coord 'orient' to earth
# #             # mark as 'true' or 'magnetic' North
# #         if axes=='princ':
# #             # check for principal heading
# #             # change coord 'orient' to principal directions
