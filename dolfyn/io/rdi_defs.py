...
data_defs = {'number': ([], 'data_vars', 'uint32', '1', '', ''),
             'rtc': ([7], 'sys', 'uint16', '1', '', ''),
             'builtin_test_fail': ([], 'data_vars', 'bool', '1', '', ''),
             'c_sound': ([], 'data_vars', 'float32', 'm/s', 'Speed of Sound', 'speed_of_sound_in_sea_water'),
             'depth': ([], 'data_vars', 'float32', 'm', 'Depth', 'depth_below_platform'),
             'pitch': ([], 'data_vars', 'float32', 'deg', 'Pitch', 'platform_pitch'),
             'roll': ([], 'data_vars', 'float32', 'deg', 'Roll', 'platform_roll'),
             'heading': ([], 'data_vars', 'float32', 'deg', 'Heading', 'platform_orientation'),
             'temp': ([], 'data_vars', 'float32', 'deg C', 'Temperature', 'sea_water_temperature'),
             'salinity': ([], 'data_vars', 'float32', 'psu', 'Salinity', 'sea_water_salinity'),
             'min_preping_wait': ([], 'data_vars', 'float32', 's', '', ''),
             'heading_std': ([], 'data_vars', 'float32', 'deg', 'Heading Std', 'platform_course_standard_devation'),
             'pitch_std': ([], 'data_vars', 'float32', 'deg', 'Pitch Std', 'platform_pitch_standard_devation'),
             'roll_std': ([], 'data_vars', 'float32', 'deg', 'Roll Std', 'platform_roll_standard_devation'),
             'adc': ([8], 'sys', 'uint8', '1', '', ''),
             ...
             'vel': (['nc', 4], 'data_vars', 'float32', 'm/s', 'Water Velocity',
             ...
             'vel_bt': ([4], 'data_vars', 'float32', 'm/s', 'Bottom Track Velocity',
             ...
             'avg_speed_gps': ([], 'data_vars', 'float32', 'm/s', 'Average Platform Speed', 'average_platform_speed_wrt_ground'),
             'avg_dir_gps': ([], 'data_vars', 'float32', 'deg', 'Average Platform Direction', 'average_platform_course'),
             'speed_made_good_gps': ([], 'data_vars', 'float32', 'm/s', 'Platform Speed Made Good', 'platform_speed_made_good'),
             'dir_made_good_gps': ([], 'data_vars', 'float32', 'deg', 'Platform Direction Made Good', 'platform_course_made_good'),
             ...
             'speed_over_grnd_gps': ([], 'data_vars', 'float32', 'm/s', 'Platform Speed', 'platform_speed_wrt_ground'),
             'dir_over_grnd_gps': ([], 'data_vars', 'float32', 'deg', 'Platform Direction', 'platform_course'),
             'heading_gps': ([], 'data_vars', 'float64', 'deg', 'GPS Heading', 'platform_course'),
             'dist_nmea': ([], 'data_vars', 'float32', 'm', 'Depth', 'depth_sounder_range'),
             'vel_sl': (['nc', 4], 'data_vars', 'float32', 'm/s', 'Water Velocity',
                        'velocity_from_multibeam_acoustic_doppler_velocity_profiler_in_sea_water'),
