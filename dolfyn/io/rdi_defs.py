...
data_defs = {'number': ([], 'data_vars', 'uint32', '1', 'Ensemble Number', 'number_of_observations'),
             ...
             'min_preping_wait': ([], 'data_vars', 'float32', 's', 'Minimum Pre-Ping Wait Time Between Measurements', ''),
             'heading_std': ([], 'data_vars', 'float32', 'degree', 'Heading Standard Deviation', ''),
             ...
             'vel': (['nc', 4], 'data_vars', 'float32', 'm s-1', 'Sea Water Velocity from ADCP', ''),
             'amp': (['nc', 4], 'data_vars', 'uint8', '1', 'Acoustic Signal Amplitude',
                     'signal_intensity_from_multibeam_acoustic_doppler_velocity_sensor_in_sea_water'),
             'corr': (['nc', 4], 'data_vars', 'uint8', '1', 'Acoustic Signal Correlation',
             ...
             'amp_bt': ([4], 'data_vars', 'uint8', '1', 'Bottom Track Acoustic Signal Amplitude', ''),
             ...
             'dir_made_good_gps': ([], 'data_vars', 'float32', 'degree', 'Platform Direction Made Good', 'platform_course'),
             ...
             'hdop_gps': ([], 'data_vars', 'float32', '1', 'Horizontal Dilution of Precision', ''),
             'elevation_gps': ([], 'data_vars', 'float32', 'm', 'Elevation above MLLW', ''),
             'rtk_age_gps': ([], 'data_vars', 'float32', 's', 'Age of Received Real Time Kinetic Signal', ''),
             'speed_over_grnd_gps': ([], 'data_vars', 'float32', 'm s-1', 'Platform Speed over Ground', 'platform_speed_wrt_ground'),
             'dir_over_grnd_gps': ([], 'data_vars', 'float32', 'degree', 'Platform Direction over Ground', 'platform_course'),
             ...
             'vel_sl': (['nc', 4], 'data_vars', 'float32', 'm s-1', 'Surface Layer Sea Water Velocity from ADCP', ''),
             'corr_sl': (['nc', 4], 'data_vars', 'uint8', '1', 'Surface Layer Acoustic Signal Correlation',
                         'beam_consistency_indicator_from_multibeam_acoustic_doppler_velocity_profiler_in_sea_water'),
             'amp_sl': (['nc', 4], 'data_vars', 'uint8', '1', 'Surface Layer Acoustic Signal Amplitude',
                        'signal_intensity_from_multibeam_acoustic_doppler_velocity_sensor_in_sea_water'),
