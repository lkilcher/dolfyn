...
vec_data = {
    ...
    'vel': _VarAtts(dims=[3],
                    ...
                    standard_name='velocity_from_multibeam_acoustic_doppler_velocity_sensor_in_sea_water',
                    ),
    'amp': _VarAtts(dims=[3],
                    dtype=np.uint8,
                    group='data_vars',
    ...
    'corr': _VarAtts(dims=[3],
                     ...
                     standard_name='beam_consistency_indicator_from_multibeam_acoustic_doppler_velocity_sensor_in_sea_water',
                     ),
}
...
vec_sysdata = {
    ...
    'error': _VarAtts(dims=[],
                      ...
                      default_val=nan,
                      long_name='Error',
                      standard_name='instrument_error',
                      ),
