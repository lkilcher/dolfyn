...
class _VarAtts():
    ...
    def __init__(self, dims=[], dtype=None, group='data_vars',
                 ...
                 offset=0, factor=1,
                 title_name=None, units='1', dim_names=None,
...
vec_sysdata = {
    ...
    'orientation_down': _VarAtts(dims=[],
                                 dtype=bool,
                                 group='data_vars',
                                 default_val=nan,
