...
waves_data = {
    ...
    'vel': _VarAtts(dims=[4, 'n'], # how to change this for different # of beams?
                   dtype=np.float32,
                   group='data_vars',
                   default_val=nan,
                   factor=0.001,
...
AST_data = {
    'amp': _VarAtts(dims=[3, 'n'],
                   dtype=np.uint8,
                   group='data_vars',
                   units='counts',
                   ),
    'amp_b4': _VarAtts(dims=[1, 'nbins', 'n'],
                      dtype=np.uint8,
                      group='data_vars',
                      units='counts',
                      ),
