...
class saveable(Dgroups):
    ...
    """
    def save_mat(self,filename,groups=None,appendmat=True,format='5',do_compression=True,oned_as='row'):
        """
        ...
        """
        with mat.saver(filename,format=format,do_compression=do_compression,oned_as=oned_as) as svr:
    ...
    def load(self,groups,where='/',filename=None,):
        ...
        with hdf5.loader(filename,None) as ldr:# Don't need a typemap, because we are using the current object.
