...
def rotate(axis):
    ...
    assert_allclose(td_sig_ieb.vel.values, td_sig_ieb_vel[axis][...,:100], atol=5e-3)
    ...
    if axis=='beam':
        ...
        assert_allclose(td_sig_ieb.vel_b5.values, td_sig_ieb_vel['b5'][...,:100], atol=1e-5)
        assert_allclose(td_sig_ie.vel_b5.values, td_sig_ie_vel['b5'][...,:500], atol=1e-5)
    
    # bottom-track
    assert_allclose(td_sig_ieb.vel_bt.values, vel_bt[axis][...,:100], atol=5e-3)
