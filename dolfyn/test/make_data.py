...
# ta.test_calc_coh(make_data=True)
# ta.test_calc_phase_angle(make_data=True)
# ta.test_calc_acov(make_data=True)
# ta.test_calc_xcov(make_data=True)
# ta.test_calc_tke(make_data=True)
# ta.test_calc_stress(make_data=True)
# ta.test_do_tke(make_data=True)
# ta.test_calc_freq(make_data=True)
# ta.test_calc_vel_psd(make_data=True)
# ta.test_calc_vel_csd(make_data=True)
